...
const staticRoutes: { path: string; priority: number; freq: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/website-design/levels', priority: 0.8, freq: 'monthly' },
  { path: '/website-design/modules', priority: 0.8, freq: 'monthly' },
  { path: '/website-design/engagement', priority: 0.7, freq: 'monthly' },
