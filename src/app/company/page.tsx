          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <dl className="mt-10 p-8 lg:p-10 rounded-3xl bg-white border border-slate-200/80 shadow-sm grid sm:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <dd className="mt-1 text-base font-semibold text-slate-900">EU · AF · MENA</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wider text-slate-500 font-semibold">Platforms</dt>
                <dd className="mt-1 text-base font-semibold text-slate-900">5 infrastructure platforms</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wider text-slate-500 font-semibold">Modules</dt>
                <dd className="mt-1 text-base font-semibold text-slate-900">18+ composable modules</dd>
              </div>
            </dl>
          </div>
        </section>
