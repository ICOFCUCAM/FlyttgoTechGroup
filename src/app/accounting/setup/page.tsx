    ...
    <main className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-14 px-6 lg:px-10">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 font-mono text-[10px] tracking-[0.22em] uppercase text-slate-400">
          ...
          <span>Accounting workspace setup</span>
        </div>
        <h1 className="mt-6 font-serif text-3xl md:text-4xl font-medium tracking-tight leading-[1.05] max-w-3xl">
          Select the accounting framework{' '}
          <em className="not-italic font-serif italic font-normal text-[#0A3A6B] dark:text-[#9ED0F9]">
            this organization will operate under.
          </em>
        </h1>
        <p className="mt-4 max-w-2xl text-sm text-slate-600 dark:text-slate-400 leading-[1.65]">
          The framework determines the chart of accounts template, base
          currency, VAT regime, fiscal-year start, and statutory report
          formats. Changing framework after journal entries are posted is
          restricted — re-statement requires a documented transition entry.
        </p>
