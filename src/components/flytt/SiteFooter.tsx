...
const groups: FooterGroup[] = [
  {
    ...
    links: [
      ...
      { label: 'Customer programmes · CS.00', href: '/customers' },
      { label: 'FlyttGo vs. comparators · CP.00', href: '/compare' },
      ...
      { label: 'Transparency report · TR.00', href: '/transparency/2026' },
      { label: 'Press & media kit · PR.MK', href: '/press' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: 'Confidential compute · DM.04', href: '/deployment/confidential' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'AI governance · AG.00', href: '/governance/ai' },
      { label: 'Open standards · OS.00', href: '/standards' },
      { label: 'SBOM registry · SB.00', href: '/sbom' },
      { label: 'Open source · OS.MF', href: '/open-source' },
      ...
      { label: 'Platform status · ST.00', href: '/status' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: 'Partner programme · PR.00', href: '/partners' },
      ...
      { label: 'Webhook tester · WH.00', href: '/developers/webhooks' },
