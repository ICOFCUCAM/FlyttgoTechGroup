...
const groups: Group[] = [
  ...
  {
    heading: 'Infrastructure Modules',
    links: [
      { label: 'Payments layer', href: '/infrastructure#infrastructure-modules' },
      { label: 'Identity layer', href: '/infrastructure#infrastructure-modules' },
      { label: 'Marketplace engine', href: '/infrastructure#infrastructure-modules' },
      { label: 'Relocation intelligence', href: '/infrastructure#infrastructure-modules' },
      { label: 'Admin dashboards', href: '/infrastructure#infrastructure-modules' },
      { label: 'Analytics layer', href: '/infrastructure#infrastructure-modules' },
    ],
  },
  {
    heading: 'Industries',
    links: [
      ...
      { label: 'Marketplaces', href: '/industries' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'API preview', href: '/developers' },
    ],
  },
  {
    heading: 'Company',
