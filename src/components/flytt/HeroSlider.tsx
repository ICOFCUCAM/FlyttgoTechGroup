...
const slides: Slide[] = [
  ...
  },
  {
    ...
    sub: 'Secure authentication and verification for citizens, contractors and enterprise users.',
    image: imagery.platforms.identra.hero,
    alt: 'Abstract identity and authentication dashboard on a dark technical interface',
  },
  {
    slug: 'payvera',
    name: 'Payvera',
    category: 'Payment Infrastructure',
    sub: 'Government-ready payment rails for permits, payouts and subscription billing.',
    image: imagery.platforms.payvera.hero,
    alt: 'Abstract payments console showing transaction flows and ledger reconciliation',
  },
  {
    slug: 'ledgera',
    name: 'Ledgera',
    category: 'Financial Operations',
    sub: 'Automated bookkeeping, tax-ready reporting and AI-powered financial intelligence.',
    image: imagery.platforms.ledgera.hero,
    alt: 'Abstract financial analytics dashboard with ledger entries and reporting views',
  },
  {
    slug: 'flyttgo',
    name: 'FlyttGo',
