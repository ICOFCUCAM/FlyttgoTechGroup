...
const CaseStudyCard: React.FC = () => {
  return (
    <section aria-labelledby="case-study-heading" className="relative py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <Reveal className="relative overflow-hidden rounded-[32px] border border-slate-200/80 bg-gradient-to-br from-white via-[#F7FAFD] to-white shadow-[0_1px_0_0_rgb(15_23_42/0.04),0_24px_48px_-16px_rgb(15_23_42/0.14)]">
          <div
            aria-hidden="true"
          ...
          <div className="relative grid lg:grid-cols-12 gap-10 p-10 lg:p-14">
            <div className="lg:col-span-7">
              <p className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full text-[11px] font-semibold text-slate-700 uppercase tracking-[0.18em]">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" aria-hidden="true" />
                Case Study · Government Service Layer
              </p>
              <h2
                id="case-study-heading"
                className="mt-5 text-3xl md:text-4xl lg:text-[44px] font-semibold tracking-tight text-slate-900 leading-[1.05]"
              >
              ...
              <div className="mt-6 relative pl-5 border-l-2 border-[#1E6FD9]/30">
                <Quote
                  size={18}
                  className="absolute -left-[11px] top-0 text-[#1E6FD9] bg-white rounded-full"
                  aria-hidden="true"
                />
                <p className="text-base lg:text-lg text-slate-700 leading-relaxed italic max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-slate-900 text-sm font-semibold rounded-lg border border-slate-200 hover:border-slate-300 hover:bg-slate-50 motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E6FD9]/40 focus-visible:ring-offset-[3px]"
                >
            ...
            <dl className="lg:col-span-5 grid grid-cols-2 gap-4 content-center">
              <div className="p-6 rounded-2xl bg-white border border-slate-200/80 shadow-[0_1px_0_0_rgb(15_23_42/0.04)]">
                <dt className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-semibold">Time-to-pilot</dt>
                <dd className="mt-3 text-3xl lg:text-4xl font-semibold tracking-tight text-slate-900">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200/80 shadow-[0_1px_0_0_rgb(15_23_42/0.04)]">
                ...
                <dd className="mt-3 text-3xl lg:text-4xl font-semibold tracking-tight text-slate-900">6 / 6</dd>
              </div>
              <div className="p-6 rounded-2xl bg-white border border-slate-200/80 shadow-[0_1px_0_0_rgb(15_23_42/0.04)]">
                <dt className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-semibold">Operators onboarded</dt>
                <dd className="mt-3 text-3xl lg:text-4xl font-semibold tracking-tight text-slate-900">14</dd>
              </div>
