...
const WhiteLabelStrategy: React.FC = () => {
  return (
    <section
      ...
      className="relative py-28 lg:py-36 bg-gradient-to-b from-[#F7FAFD] via-white to-[#F5F8FC]"
    >
          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-slate-900 hover:gap-3 motion-safe:transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E6FD9] focus-visible:ring-offset-2 rounded-sm"
              >
          ...
          {pillars.map((p) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-sm lg:text-base text-slate-600 leading-relaxed">{p.description}</p>
