...
const InvestorSection: React.FC = () => {
  ...
  return (
    <section id="investors" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <h2 className="mt-5 text-3xl md:text-4xl lg:text-[44px] font-semibold tracking-tight text-slate-900 leading-[1.1]">
              ...
              {architecture.map((a, i) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-slate-900">{a.layer}</div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 p-8 rounded-2xl bg-gradient-to-br from-[#0A1F3D] to-[#0A3A6B] text-white relative overflow-hidden">
              <div className="flex items-start justify-between gap-6 flex-wrap">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-full text-xs font-semibold">
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={r.region} className="p-4 bg-white/5 border border-white/10 rounded-xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {['Logistics Networks', 'Education Systems', 'Municipal Services', 'Enterprise Fleets', 'Marketplaces'].map(
                  (i) => (
                    <div
                      key={i}
                      className="p-3 bg-slate-50 rounded-lg text-xs font-medium text-slate-700 text-center"
                    >
                      {i}
                    </div>
                  ),
