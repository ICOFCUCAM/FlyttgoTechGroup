...
const GovernmentSection: React.FC = () => {
  return (
    <section
      ...
      className="relative py-24 lg:py-32 bg-gradient-to-b from-[#F7FAFD] via-white to-[#F5F8FC]"
    >
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {programmes.map((p) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-6 text-xl font-semibold text-slate-900 tracking-tight">{p.title}</h3>
                ...
                <div className="mt-6 pt-6 border-t border-slate-100 text-[11px] uppercase tracking-wider font-semibold" style={{ color: p.accent }}>
        ...
        <div className="mt-10 grid lg:grid-cols-12 gap-6">
          <aside className="lg:col-span-5 p-8 lg:p-10 rounded-3xl bg-white border border-slate-200/80">
            ...
            <h3 className="mt-3 text-xl lg:text-2xl font-semibold text-slate-900 tracking-tight leading-tight">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-[#0A3A6B] font-semibold rounded-lg hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A3A6B]"
                >
